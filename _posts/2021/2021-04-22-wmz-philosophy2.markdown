...
误解1：认为绝对精神是Idea理念，即误解为柏拉图式的理念、统摄世界的力量，教科书称之为客观唯心主义，这类误解顶多是黑格尔绝对精神的某项环节

黑格尔的理论分为：  
1、逻辑学logic，对应形式智慧  
2、形而上学metaphysics，对应实质智慧(1和2构成哲学)  
3、现实实质哲学Realphliosophy，如心理学、社会学等具体的东西

黑格尔的整个哲学体系中，没有可以统摄整个哲学体系的理念来维持其同一性

误解2：绝对精神是上帝的灵魂和精神，主要来源于笛卡尔开始的近代哲学，其结构为上帝统摄自然，在上帝与自然之间(中介)是人类有限的心智，上帝创造了自然和人的灵魂

绝对精神不是上帝灵魂，那个时代在普鲁士王权和基督教社会的夹击之下，黑格尔不得已将其称为上帝的精神

## 绝对精神

绝对精神Geist是一种**运动**，除了运动外什么也不是，所以叫Absolute spirit，它没有规定性，是实体substance的一种运动，它必然要动，动起来就会划分出**主体和实体**，它的运动必然要把主体性的维度甩出去(**主体不是实体**，而反过来**实体是主体**，这是辩证法的精髓。实体是主体意味着实体是自我分裂的，它一定会甩出一个符号学的面)。绝对精神就是**自我分裂的运动**splite，所以绝对精神是高于实体的，"实体"是绝对精神运动的痕迹/踪迹。主体是可以把实体去实体化的，把它看成虚无，为什么会有这种能力？因为它(实体)本来就不是实体化的东西，只有这个运动本身是实实在在存在的，是由于要克服内在的僵局(抵触性的，这个运动永远无法克服/瓦解的东西，这个才是真的实体，但是它是不会实体化的)，故产生运动。实体必然有一种去实体化的运动，这种运动就是主体，**主体就是实体自身去实体化的运动**。归根结底"实体本身不存在"，我们是主体可以这样说出来，且唯有主体可以这样说，因为**主体就是实体自己内在否定自己的那个力量**，你是否定的力量，所以可以这样说，但是你必须实体化才能把这句话说出来，这是暂时的真相，在黑格尔那里所有都是运动的。"实体不存在"是个主体道出的真理，黑格尔辩证法的张力就在于它**必须被道出**，即这个真理本身必须被实体化为词和语音，这样才具有否定性的力量，才能作为一个命令一样下到实体本身上去，这是主体内在的否定性力量，这个力量必须要实体化才有力量，你不能不说话空想、朝向空，这时是无法**Tell**(说/创造，分别/发现，这两个是同个过程，在哲学核心内部这种短路是实时发生的，即**创造与发现的短路**) the Truth的，如同想到了的虚无已经不是虚无了，是主体已实体化了的概念了

主体性否定性的运动在实体内核是**构成性的必要**，实体要去实体化需要变成主体才能去实体化，把握到自己其实只是绝对精神运动的一个残影。同时实体想要实体化也需要主体，需要主体来感受表象，需要意识通过划分**表象和本质的二分**，需要主体把实体的分裂内化为主体自己身上去。实体要么是实体、要么是绝对精神运动的痕迹/效果(非实体)，它同时也想要成为实体，那么实体只能把不稳地的力量甩出去成为了主体，那么**实体的矛盾/不稳定力量(二分)由主体承接**，主体回过头去对实体进行表象，然后在表象背后创造了**二阶表象**(即本质)，这时主体则认为表象是临时的、痕迹的、虚无的，而那个看不见摸不着的才是真实的，由此实体**暂时**获得了对自己的救赎/梦寐以求的实体性。即实体通过甩出主体的方式使得它的两个维度都得到解放(实在和虚拟的面向)，即通过主体对表象背后的物自体的想象，这种物自体会被主体把握到一种超出他把握能力之外的一种超越性的物，而虚拟的那一面会被把握成主体自己时时刻刻都具有的抽象的否定性的自由(实体本身如同鬼魅般、作为绝对精神运动的一个纯痕迹/幻影的力量，就会被主体继承到他的内在核心，即抽象的否定性，这种**抽象否定性**就是自由，主体内在永远涌动的自由)(abstract和absolute可以理解为一个意思：分离)

所以实体是主体，主体不是实体，主体最内在的核心的规定性是非实体/**去实体化**的，主体的核心本质在于一种去实体化的能力


康德哲学主要包含两个部分：
+ 纯粹理性批判：准备工作，先验逻辑是形式智慧，不触及实质
+ 实践理性批判：形式智慧的应用
+ 批判力批判：有一定的实质智慧，形而上学，比如认为"美是goodness(本体性)的象征"，是合目的性 ，不直接等同于善

比如"热情是自由的象征"，即本地性的力量是可现身的，其实这些都是视差之见(齐泽克)，在两者的差异之中，是一种运动，美是僵局中的运动，可以用来象征那个本体性的东西，这个运动在感性中得到了实体化，但是实际上美究竟是何物，则是额外的规定性了。所以康德的纯粹理性批判是纯粹逻辑，没有实质性的东西，都是一些手续和规则，而在实践理性批判和批判力批判里面才开始慢慢讲到这些规则如何被运用

有些人认为黑格尔那里也有逻辑学、形而上学、实质哲学。但是黑格尔晚期时已经意识到，**absolute(绝对)**并非超越性的对象，而是**贯穿在所有相对的、有限的、被主体/意识介入的过程中的一种共同的运动**，所以黑格尔晚期会研究形而上学，研究绝对者的实质性的规定/智慧(比如颜色、爱欲)，所以最后会告诉你，**形而上学和逻辑学是同一种东西**，当你描述逻辑学的时候，就是描述相对的有限的主体要去把握世界所必须(被迫)遵循的形式规则的时候，即being逻辑--》essence本质--》notion概念等知识合法性的形式规定，这些本身就是形而上学。什么东西在设立整个知识的合法性？就是这个实体本身，这种绝对的运动，这并不是有个超越性的对象在那边，不是的，它早以一种否定性的方式介入认识活动了，所以所有的认识活动中都可以把握绝对。当你在察觉、分析什么样的知识是合法的、什么是非法的，进行逻辑学的建构的时候就已经在建构形而上学/本体论了，所以这两种东西是同一种东西。否则学习的黑格尔就变成了一个非历史主义的劣版谢林了(谢林那边，上帝是受自身束缚的、历史性的，本体论的开端是上帝和它自己的矛盾。而在真正的黑格尔那边不需要这个维度，因为黑格尔没有给上帝本体论开端的位置)，后人通常批判一个劣化误解的黑格尔理论来把握理解黑格尔的思想、自己坐上黑格尔的位置

所以不要把Geist理解成一种实体化的东西，它不是实体，但是它**有实体化的能力**，它可以实体化

学习黑格尔的一些忠告：在学习时无论什么学术名词，比如主体、客体、实体、自身、他者等，后面都加"化"字，去想象/把握一个**动态过程**，而不是把握其关系，那么关系如何关系化的？实际就是一个抽象的普遍性/规定如何变成具体的普遍性/规定，它需要一个外部性来做一个支撑。只有当你思考关系是如何关系化、部署它自己、实现它自己的时候，才能把握辩证法，而在辩证法的视角下，所有的XX化不是在一种多元主义的相互关系、自由滑动里的，当然它们互相之间有关系，但是这些关系如何实现？关系化对于不同的东西来说，其逻辑运动的拓扑学结构是不一样的。所以学习哲学需要一点空间想象力，哲学至少是华容道(挪动时有互相的牵制)，还是扫雷(有些地方是不能点/挪动的)，这种严密的逻辑关系(概念间的空间关系)就是逻辑学，这个空间关系要去时间化的时候就变成一种形而上学。黑格尔就告诉你，学习形而上学不需要追求一个超越的时间维度，而是这些逻辑学内部的空间关系本身就已经在决定怎么时间化了、在现实中怎么实现了，因为逻辑学内部之所以有这些空间关系，就是因为有一种否定性的力量已经介入其中了，已经在给它们设立界限了，这种空间关系本身已经是一种绝对的的时间性在介入其中了

学习黑格尔哲学，要克服恋物癖，不可停留在词、画面的固定概念意识中，但同样不可以将能指漂浮于空中永远滑动(解构主义者)，该停留得停留、该落下批判便落下

黑格尔是个冷酷的哲学家，是一个哲学做题家，基本把本体论和逻辑学的题全做完了，把知识可能的条件都阐述了
